...
from management_server.routers import (
    staff_routers,
    admin_routers,
    auth_routers,
    department_routers,
...
server.add_exception_handler(ValidationError, _validation_error_handler)
...
server.include_router(department_routers.router)
